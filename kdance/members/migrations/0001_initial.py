# Generated by Django 4.2.13 on 2024-07-22 01:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_courses', models.ManyToManyField(to='members.course')),
                ('cancelled_courses', models.ManyToManyField(related_name='members', to='members.course')),
                ('contacts', models.ManyToManyField(related_name='members_cancelled', to='members.contact')),
